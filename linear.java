...
public class Main {
    ...
    public static double[] multipleRegression(double[] y, Matrix x) {
        ...
        // return cx.times(x).inverse().times(cx).times(cy).get(0);
    }
    ...
    public static void main(String[] args) {
        ...
        double[] y = new double[]{23.25, 20.25, 22, 25.1, 25.9};
        var x = new Matrix(new double[][]{
            {0.555667, 0.517833, 0.585333, 0.692167, 0.697},
            {0.1912, 0.2192, 0.1417, 0.1749, 0.2513},
            {1, 1, 1, 1, 1}
        });
        var v = multipleRegression(y, x);
        printVector(v);
